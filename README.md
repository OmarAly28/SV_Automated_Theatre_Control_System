...
This project implements a synchronous control system for a multi-purpose theatre. The system is responsible for coordinating the house lights, visualization
